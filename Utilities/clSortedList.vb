'------------------------------------------------
'Name: clSortedList.vb
'Function: Generic sortable binding list.
'Copyright Robin Baines 2012. All rights reserved.
'Notes: An alternative is to use SortableBindingList from Microsoft.SqlServer.Management.Controls.
'Modifications: 
'------------------------------------------------
Imports System
