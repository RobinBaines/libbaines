'------------------------------------------------
'Name: clParseSQL.vb.
'Function: A rudimentary parser of SQL; used to show some colours in rhw frmMetaProc and frmMetaView.
'Created Jan 2016.
'Notes: 
'Modifications:
'------------------------------------------------
...
Public Class clParseSQL
    ...
    Friend WithEvents typesTableAdapter As MetaDataSetTableAdapters.typesTableAdapter
    Friend WithEvents m_sql_charactersTableAdapter As MetaDataSetTableAdapters.m_sql_charactersTableAdapter
    Friend WithEvents m_keywordsTableAdapter As MetaDataSetTableAdapters.m_keywordsTableAdapter
    Dim tbl_types As MetaDataSet.typesDataTable
    Dim tbl_m_sql_characters As MetaDataSet.m_sql_charactersDataTable
    Dim tbl_m_keywords As MetaDataSet.m_keywordsDataTable
    ...
    Public Sub Init()
        ...
        Me.typesTableAdapter = New MetaDataSetTableAdapters.typesTableAdapter()
        Me.m_sql_charactersTableAdapter = New MetaDataSetTableAdapters.m_sql_charactersTableAdapter()
        Me.m_keywordsTableAdapter = New MetaDataSetTableAdapters.m_keywordsTableAdapter()
    ...
    Private Function IsType(strT As String) As Boolean
        For Each tbl_typeRow As MetaDataSet.typesRow In tbl_types
    ...
    Private Function IsKeyword(strT As String) As Boolean
        For Each tbl_m_keywordsRow As MetaDataSet.m_keywordsRow In tbl_m_keywords
    ...
    Public Sub ParseRTB(rtb As RichTextBox)
        ...
        'sql types
        For Each tbl_typesRow As MetaDataSet.typesRow In tbl_types
            iIndex = 0
            While iIndex > -1
                ...
                If iIndex > -1 Then
                    ...
                    If iIndex + tbl_typesRow.name.Length = rtb.Text.Length Then
                        ...
                        rtb.SelectionColor = Color.Blue
                    Else
                        If (String.IsNullOrWhiteSpace(rtb.Text.Substring(iIndex + tbl_typesRow.name.Length, 1)) Or _
                            rtb.Text.Substring(iIndex + tbl_typesRow.name.Length, 1) = "(" Or _
                             rtb.Text.Substring(iIndex + tbl_typesRow.name.Length, 1) = ")") And _
        ...
        For Each tbl_m_sql_charactersRow As MetaDataSet.m_sql_charactersRow In tbl_m_sql_characters
            iIndex = 0
            While iIndex > -1
                ...
                If iIndex > -1 Then
                    ...
                    Else
                        If String.IsNullOrWhiteSpace(rtb.Text.Substring(iIndex + tbl_m_sql_charactersRow.characters.Length, 1)) Or _
