'------------------------------------------------
'Name: Module gen_TheDataSet_m_tble.vb.
'Function: 
...
Public Class TheDataSet_m_tble
Inherits dgColumns
...
ByVal _ta As TheDataSetTableAdapters.m_tbleTableAdapter, _
...
MyBase.New(strForm, "m_tble", _bs, _dg, _ta, _ds, _MainDefs, blnRO, _
"tble","",_Controls, _frmStandard, blnFilters)
...
DefineColumn(dgtble, "tble", blnRO, ds.m_tble.tbleColumn.MaxLength)
PutColumnsInGrid()
...
Try
Dim tadap As TheDataSetTableAdapters.m_tbleTableAdapter
tadap = CType(ta, TheDataSetTableAdapters.m_tbleTableAdapter)
tadap.Delete(e.Row.Cells(dg.Columns("tble").Index).Value.ToString())
